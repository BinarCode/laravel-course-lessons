...
@section('content')
    ...
    <div class="bg-gray-50 pb-16 px-4 overflow-hidden sm:px-6 lg:px-8 lg:pb-24">
        <div class="relative max-w-xl mx-auto">
            ...
            <div class="mt-12">
                <form action="{{action('SushiController@update', ['sushi' => $sushi->id])}}" method="POST" class="grid grid-cols-1 row-gap-6 sm:grid-cols-2 sm:col-gap-8">
                    @csrf
                    @method('PUT')
                    <div class="sm:col-span-2">
                        <label for="name" class="block text-sm font-medium leading-5 text-gray-700">Name</label>
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input id="name" name="name" value="{{$sushi->name}}" class="form-input py-3 px-4 block w-full transition ease-in-out duration-150" />
                        </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input id="price" name="price" value="{{$sushi->price}}" type="number" class="form-input py-3 px-4 block w-full transition ease-in-out duration-150" />
                        </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input id="image" name="image" type="url" value="{{$sushi->image}}" class="form-input py-3 px-4 block w-full transition ease-in-out duration-150" />
                        </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <textarea id="description" name="description" rows="4" class="form-textarea py-3 px-4 block w-full transition ease-in-out duration-150">{{$sushi->description}}</textarea>
                        </div>
                    </div>
                    <div class="sm:col-span-2">
